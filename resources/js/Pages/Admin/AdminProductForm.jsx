...
import { 
    Upload, X, ArrowLeft, Plus, Trash2, Link as LinkIcon, CheckCircle2,
    Image as ImageIcon, Images, Youtube, MousePointerClick, HelpCircle, 
    ChevronUp, ChevronDown, GripVertical, ArrowUpDown, Info
} from 'lucide-react';
...
export default function AdminProductForm({ dbCategories = [], product }) {
    ...
    const addMaterial = () => {
        ...
        setForm(prev => ({ ...prev, materials: [...prev.materials, { title, duration, link }] }));
        setNewMaterialTitle('');
        setNewMaterialMeta('');
        setNewMaterialLink('');
    };
    ...
    const handleSave = () => {
        ...
        // Build FormData manually so we can attach block files
        // We'll send landingBlocks as JSON string and images as landingBlockImages[idx] or landingBlockImages[idx_imgIdx]
        ...
        <AdminLayout>
            ...
            <div className="admin-page">
                <div className="admin-page-header">
                    ...
                    <p className="admin-page-subtitle">Lengkapi formulir di bawah ini untuk mengelola detail produk, materi, dan tampilan landing page.</p>
                </div>
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                                    ...
                                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                                            ...
                                                            {m.duration && (
                                                                <span style={{ color: 'var(--color-accent)', fontSize: '10px', padding: '1px 6px', background: 'var(--color-accent-dim)', borderRadius: 4, fontWeight: 700 }}>{m.duration}</span>
                                                            )}
                                                        </div>
                                                        {m.link && (
